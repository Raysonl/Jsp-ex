...
<body class="layui-view-body">
 <div class="layui-content">
	...
	<form action="showPrepareByStaff.jsp" method="post">
	<table style="opacity:0.6;position:absolute;left:10px; top: 50px; width:490px;height:300px ; font-family:'../Montserrat-Bold.ttf';font-size:17px">
		<tr>
			...
			<td><input type="text" name="CN" class="layui-input-inline" style="width: 100px;"/></td>
		</tr>
		
		<tr>
			<td><div class="layui-form-mid"> Work Year Larger than:</div></td>
			<td><input type="text" name="TN" class="layui-input-inline" style="width: 100px;"/> *This is required</td>
		</tr>
		
		<tr>
			<td><div class="layui-form-mid"> Salary Larger than:</div></td>
