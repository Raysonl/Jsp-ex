  ...
  <h4>课程号是主键，不能重复，每个信息都必须输入！</h4>
	...
	<table  border="1"  style="opacity:0.6;position:absolute;left:10px; top: 50px; width:400px;height:300px;background-color:#8AC007 ; font-family:'../Montserrat-Bold.ttf';font-size:24px">
		...
		<tr>
			...
			<td> <input type="radio" name="CT" value="Male" />Male
			 <input type="radio" name="CT" value="Female" /> Female
			 </td>
		</tr>
		...
		<tr>
			<td><input type="submit" value="添加" class="layui-btn layui-btn-blue"></td>
			<td><input type="reset" value="重置" class="layui-btn layui-btn-blue"></td>
		</tr>
	</table>
	</form>  
                </div>
